...
function getCartItems(){
    ...
    ->where(['user_id'=>$uid])
    ->where(['user_type'=>$user_type])
    ->select('cart.qty','products.id as pid','products.name','products.slug','products.image'
               ,'products_attr.id as attrId','products_attr.price','sizes.size','colors.color')
    ->get();
